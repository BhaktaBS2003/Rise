...
const HorizontalScrollSection = () => {
  ...
  const cards = [
    {
      ...
      description:
        "Present innovative research across emerging technology domains.",
      image: "/flyer2.webp",
      color: "bg-primary",
      icon: "note",
      link: "https://share.google/fl3vIgl6CUSazbj1K",
      rulebookLink: "https://drive.google.com/file/d/1FaXPG6hikTMu3_Vydhlf20tV768KU1iQ/view?usp=drivesdk"
    },
    {
      id: 2,
      title: "Clash of Perspectives",
      description:
        "Express ideas through creative interpretation and perspective.",
      image: "/flyer1.webp",
      color: "",
      icon: "light",
      link: "https://share.google/BZ3RkV2fyTDghfTW8",
      rulebookLink: "https://drive.google.com/file/d/1xrOoMvrh0fHwCAuQ_Gbq_6NInr1HWsz6/view?usp=drivesdk"
    },
    {
      id: 3,
            ...
            <div className="flex gap-6 w-max">
              {cards.map((card, index) => (
                ...
                >
                  ...
                  <div className="relative rounded-2xl comic-border overflow-hidden">
                    {/* Background Image */}
                    <img
                      src={card.image}
                      alt={card.title}
                      className="w-full h-128 object-fill"
                    />

                    {/* Black Gradient Overlay - Fades from bottom to middle */}
                    <div className="absolute inset-0 bg-linear-to-t from-black via-black/40 to-transparent"></div>

                    {/* Title and Number on Image */}
                    <div className="absolute bottom-0 left-0 right-0 p-5">
                      <div className="flex items-center justify-between">
                        <h3 className="text-xl font-black text-white uppercase italic max-w-[90%] leading-tight">
                          {card.title}
                        </h3>
                      </div>
                      <p className="text-sm font-bold text-gray-400 mt-1 line-clamp-2 italic">
                        {card.description}
                      </p>
                    </div>
                  ...
                  <div className="flex gap-3 mt-4 px-4">
                    ...
                    <button
                      ...
                      className="px-2 flex-1 bg-blue-500 hover:bg-blue-600 text-white text-xs font-black py-3 comic-border uppercase transition-all duration-300 hover:-translate-y-1 flex items-center justify-center gap-2"
                    >
                      Register Now
                    </button>
                    ...
                    {/* Rule Book Button */}
                    <button
                      onClick={() => window.open(card.rulebookLink, "_blank")}
                      className="px-2 flex-1 bg-yellow-400 hover:bg-yellow-500 text-black text-xs font-black py-3 comic-border uppercase transition-all duration-300 hover:-translate-y-1 flex items-center justify-center gap-2"
                    >
                      Rule Book
                    </button>
                  </div>
  ...
  return (
    <section
      ref={containerRef}
      className="relative bg-background-light dark:bg-background-dark pt-24"
      id="events"
    >
      {/* Heading Section */}
            ...
            {cards.map((card, index) => (
              ...
              >
                ...
                >
                  ...
                  <button
                    onClick={() => window.open(card.link, "_blank")}
                    className="absolute top-6 left-6 z-20 bg-blue-500 text-white text-md font-black px-4 py-2 comic-border hover:bg-blue-700 transition-all duration-300 uppercase hover:-translate-y-1 hover:shadow-[4px_4px_0px_#000] animate-bounce"
                  >
                    Register Now
                  </button>
